...
class WorkflowApiIT {
    ...
    void createsValidatesPublishesAndReadsImmutableVersionThroughApi() throws Exception {
        ObjectNode workflow=jsons.object();workflow.put("id","WF-API-JPA");workflow.put("name","Workflow API JPA");workflow.put("type","CUSTOM");workflow.put("module","Test");workflow.put("ownerId","U000");workflow.put("draftVersion","1.0");workflow.putObject("trigger").put("type","manual");workflow.putArray("variables");
